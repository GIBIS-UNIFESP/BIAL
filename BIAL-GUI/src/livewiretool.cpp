...
double LiveWireTool::getAlpha( ) const {
  return( alpha );
}

void LiveWireTool::setAlpha( double value ) {
  alpha = value;
}

double LiveWireTool::getBeta( ) const {
  return( beta );
}

void LiveWireTool::setBeta( double value ) {
  beta = value;
}

int LiveWireTool::getDrawType( ) const {
  return( drawType );
}

void LiveWireTool::setSeedsVisibility( bool vis ) {
  seedsVisible = vis;
  emit guiImage->imageUpdated( );
}

void LiveWireTool::setMaskVisibility( bool vis ) {
  maskVisible = vis;
  emit guiImage->imageUpdated( );
}

bool LiveWireTool::getSeedsVisible( ) const {
  return( seedsVisible );
}

bool LiveWireTool::getMaskVisible( ) const {
  return( maskVisible );
}

void LiveWireTool::setThickness( int value ) {
  thickness = value;
  COMMENT( "thickness set to" << thickness, 2 );
}

bool LiveWireTool::isInitiated( ) const {
  return( initiated );
}
...
void LiveWireTool::drawSeed( Bial::Point3D last, Bial::Point3D current ) {
...
void LiveWireTool::setDrawType( int type ) {
  drawType = type;
}

void LiveWireTool::clearSeeds( ) {
...
template< class D >
void LiveWireTool::InitiateSeeds( size_t map_set,
...
void LiveWireTool::GeodesicSum( Bial::Image< int > &img,
                                const Bial::Vector< size_t > &obj_seeds,
                                const Bial::Vector< size_t > &bkg_seeds,
                                float alpha,
                                float beta ) {
...
void LiveWireTool::GeodesicSum( Bial::Image< float > &img,
                                const Bial::Vector< size_t > &obj_seeds,
                                const Bial::Vector< size_t > &bkg_seeds,
                                float alpha,
                                float beta ) {
...
void LiveWireTool::Watershed( Bial::Image< int > &img,
                              const Bial::Vector< size_t > &obj_seeds,
                              const Bial::Vector< size_t > &bkg_seeds ) {
  try {
...
void LiveWireTool::Watershed( Bial::Image< float > &img,
                              const Bial::Vector< size_t > &obj_seeds,
                              const Bial::Vector< size_t > &bkg_seeds ) {
  try {
    if( ( initiated ) && ( pf != 1 ) ) {
...
void LiveWireTool::FSum( Bial::Image< int > &img,
                         const Bial::Vector< size_t > &obj_seeds,
                         const Bial::Vector< size_t > &bkg_seeds ) {
  try {
    qDebug( ) << "FSum: pf: " << pf;
...
void LiveWireTool::FSum( Bial::Image< float > &img,
                         const Bial::Vector< size_t > &obj_seeds,
                         const Bial::Vector< size_t > &bkg_seeds ) {
  try {
    qDebug( ) << "FSum: pf: " << pf;
...
Bial::Image< int > LiveWireTool::connect( int pf_type, double alpha, double beta ) {
  if( grad_type == -1 ) {
...
void LiveWireTool::MorphologicalGradient( ) {
  switch( guiImage->getImageType( ) ) {
      case Bial::MultiImageType::int_img:
...
void LiveWireTool::SobelGradient( ) {
  switch( guiImage->getImageType( ) ) {
      case Bial::MultiImageType::int_img:
