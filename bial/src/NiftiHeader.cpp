...
#if defined ( BIAL_EXPLICIT_LIB ) && ( BIAL_NiftiHeader )
#define BIAL_EXPLICIT_NiftiHeader
#endif
#if defined ( BIAL_EXPLICIT_NiftiHeader ) || ( BIAL_IMPLICIT_BIN )
...
#ifdef BIAL_EXPLICIT_NiftiHeader
