...
#if defined ( BIAL_EXPLICIT_LIB ) && ( BIAL_MatrixPolar )
#define BIAL_EXPLICIT_MatrixPolar
#endif

#if defined ( BIAL_EXPLICIT_MatrixPolar ) || ( BIAL_IMPLICIT_BIN )
...
#ifdef BIAL_EXPLICIT_MatrixPolar
