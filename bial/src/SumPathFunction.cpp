...
namespace Bial {
  ...
  SumPathFunction< C, D >::SumPathFunction( const C< D > &handicap ) try : 
  ...
  template< template< class D > class C, class D >
  void SumPathFunction< C, D >::Initialize( C< D > &init_value, C< int > *init_label, C< int > *init_predecessor,
  ...
  template< template< class D > class C, class D >
  inline bool SumPathFunction< C, D >::Capable( int index, int adj_index, BucketState adj_state ) {
    try {
  ...
  template< template< class D > class C, class D >
  bool SumPathFunction< C, D >::Propagate( int index, int adj_index ) {
    try {
