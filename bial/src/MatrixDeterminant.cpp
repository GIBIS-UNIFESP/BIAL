...
#if defined ( BIAL_EXPLICIT_LIB ) && ( BIAL_MatrixDeterminant )
#define BIAL_EXPLICIT_MatrixDeterminant
#endif

#if defined ( BIAL_EXPLICIT_MatrixDeterminant ) || ( BIAL_IMPLICIT_BIN )
...
#ifdef BIAL_EXPLICIT_MatrixDeterminant
