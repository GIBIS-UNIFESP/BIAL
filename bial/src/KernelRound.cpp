...
#ifndef BIALKERNELROUND_C
#define BIALKERNELROUND_C

#include "KernelRound.hpp"

#if defined ( BIAL_EXPLICIT_LIB ) && ( BIAL_KernelRound )
#define BIAL_EXPLICIT_KernelRound
#endif
#if defined ( BIAL_EXPLICIT_KernelRound ) || ( BIAL_IMPLICIT_BIN )
...
#ifdef BIAL_EXPLICIT_KernelRound
