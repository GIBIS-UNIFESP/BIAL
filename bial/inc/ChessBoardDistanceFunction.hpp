...
#ifndef BIALCHESSBOARDDISTANCEFUNCTION_H
#define BIALCHESSBOARDDISTANCEFUNCTION_H
...
namespace Bial {
  ...
  class ChessBoardDistanceFunction : public DistanceFunction< ChessBoardDistanceFunction > {
...
namespace Bial {
  ...
  template< class D >
  double ChessBoardDistanceFunction::Distance( const D *src, const size_t dms ) {
    double dist = 0.0;
  ...
  template< class D >
  double ChessBoardDistanceFunction::Distance( const D *src, const D *tgt, const size_t dms ) {
    double dist = 0.0;
    for( size_t ftr = 0; ftr < dms; ++ftr ) {
...
#include "ChessBoardDistanceFunction.cpp"
