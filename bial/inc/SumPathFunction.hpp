...
#ifndef BIALSUMPATHFUNCTION_H
#define BIALSUMPATHFUNCTION_H
...
namespace Bial {
  ...
  class SumPathFunction : public PathFunction< C, D > {
  ...
  public:
     ...
     * @param handicap: Handicap value for initial cost propagation.
     * @return none.
     * @brief Basic constructor.
     * @warning none.
     */
    SumPathFunction( C< D > &init_value, C< int > *init_label, C< int > *init_predecessor, bool sequential_label, 
                     const C< D > &handicap );
     ...
     * @warning none.
     */
    SumPathFunction( const SumPathFunction< C, D > &pf );
     ...
     * @warning none.
     */
    SumPathFunction< C, D > operator=( const SumPathFunction< C, D > &pf );
