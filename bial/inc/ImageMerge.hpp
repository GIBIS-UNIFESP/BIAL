...
#ifndef BIALIMAGEMERGE_H
#define BIALIMAGEMERGE_H
...
namespace Bial {
  ...
  namespace ImageOp {
     ...
     * @param new_pixel_size: Pixel dimension of the new space.
     * @return Resultant merged 3D spatial image.
     * @brief Static constructor of a 3D spatial image, from an vector of 2D images. Images may or may not have
     * channels.
