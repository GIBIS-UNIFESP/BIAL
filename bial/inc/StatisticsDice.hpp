...
#ifndef BIALSTATISTICSDICE_H
#define BIALSTATISTICSDICE_H
...
namespace Bial {
  ...
  namespace Statistics {
     ...
     * @return The value given by Dice metric as comparing src_label and tgt_label.
     * @brief Computes and returns the value given by Dice metric as comparing src_label and tgt_label.
     * @warning none.
     */
     ...
     * @return The value given by Dice metric as comparing src_label and tgt_label.
     * @brief Computes and returns the value given by Dice metric as comparing src_label and tgt_label. This
     * function
