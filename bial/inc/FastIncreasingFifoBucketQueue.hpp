...
#ifndef BIALFASTINCREASINGFIFOBUCKETQUEUE_H
#define BIALFASTINCREASINGFIFOBUCKETQUEUE_H
...
namespace Bial {
  ...
  class FastIncreasingFifoBucketQueue : public BucketQueue {
  ...
  public:
     ...
     * @warning none. 
     */
    FastIncreasingFifoBucketQueue( size_t size, ldbl minimum_value, size_t n_buckets );
...
#include "FastIncreasingFifoBucketQueue.cpp"
