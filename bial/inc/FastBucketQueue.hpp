...
#ifndef BIALFASTBUCKETQUEUE_H
#define BIALFASTBUCKETQUEUE_H
...
namespace Bial {
  ...
  class FastBucketQueue : public BucketQueue {
  ...
  public:
     ...
     * @warning none. 
     */
    FastBucketQueue( size_t size, ldbl minimum_value, size_t n_buckets, bool increasing_order = true, bool fifo_tie = true );
