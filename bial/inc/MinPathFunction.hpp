...
#ifndef BIALMINPATHFUNCTION_H
#define BIALMINPATHFUNCTION_H
...
namespace Bial {
  ...
  class MinPathFunction : public PathFunction< C, D > {
  ...
  public:
     ...
     * @warning none.
     */
    MinPathFunction( const MinPathFunction< C, D > &pf );
