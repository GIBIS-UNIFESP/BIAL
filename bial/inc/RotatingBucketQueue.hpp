...
#ifndef BIALROTATINGBUCKETQUEUE_H
#define BIALROTATINGBUCKETQUEUE_H
...
namespace Bial {
  ...
  public:
     ...
     * @param max_dist: Maximum rotating between elements that simultaneously present in the queue.
     * @return none. 
     * @brief Basic Constructor. 
     * @warning none. 
     */
    RotatingBucketQueue( size_t size, size_t max_dist );
...
#include "RotatingBucketQueue.cpp"
